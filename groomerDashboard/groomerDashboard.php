...
<head>
    ...
    <link rel="stylesheet" href="style_groomerDashboard.css">
    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="../updateProfile_groomer/updateProfile.php">
                ...
                <li><a href="../groomer_freeConsultation/freeConsultation.php">
    ...
    <section class="dashboard">
      ...
      ?>
                ...
                <td>
                    ...
                    <img src="../img/<?php echo $row["image"]; ?>" width=150 height=200
