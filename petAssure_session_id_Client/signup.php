...
if ($_SERVER["REQUEST_METHOD"] == "POST")
 {
   ...
   $email = $_POST['email'];
    ...
    $sql= "INSERT INTO serviceprovider (fname,nic, mobile, stype ,email, address,uname,password,district,details) VALUES ('$fname' ,'$nic','$mobile','$stype','$email','$address','$uname','$password','$district','$details')";
        ...
        <div class="right_body_signup">
            ...
            <div class="form_right">
                <form name="signUpForm" action="signup.php" method="post">
                    ...
                    <input type="text" name="nic" id="nic" placeholder="Enter NIC" pattern="[0-9]{9}[Vv0-9]{1,3}"
                        required />
