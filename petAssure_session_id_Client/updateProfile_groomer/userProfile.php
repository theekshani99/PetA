...
<body>
    ...
    <body class="profile-page">
      ...
      ?>
                            ...
                            <td>
                                <img src="../groomer_img/<?php echo $row["image"]; ?>" width=150 height=200
          ...
          ?>
            ...
            <center>
                ...
                <button class="form_btn2"
                    onclick="location.href='updateProfile.php?details=<?php echo $rows['details']; ?> &fname=<?php echo $rows['fname']; ?> &nic=<?php echo $rows['nic']; ?>  &district=<?php echo $rows['district']; ?>  &email=<?php echo $rows['email']; ?> &uname=<?php echo $rows['uname']; ?> &district=<?php echo $rows['district']; ?>&mobile=<?php echo $rows['mobile']; ?>'">Update</button>
